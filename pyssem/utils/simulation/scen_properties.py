...
class ScenarioProperties:
    ...
    def initial_pop_and_launch(self, baseline=False, launch_file=None):
        ...
        if launch_file == 'adept':
            ...
            # launch_file_path = os.path.join('pyssem', 'utils', 'launch', 'data', 'ex1_intact_objs_nfl_new.csv')
            ...
            # launch_file_path = os.path.join('pyssem', 'utils', 'launch', 'data', 'ex1_intact_objs_baseline_new.csv')
